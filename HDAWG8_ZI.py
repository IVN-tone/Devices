class AWG_ZI:
    def __init__(self, hdawg, grouping, seq_pgm=None, awg_name=None, readout=None, qubit=None, coupler=None):
        self.hdawg = hdawg
    ...
    def configure_readout_triggers(self):
        self.hdawg.setInt(f'/{awg_name_ro}/awgs/{self.ro.awg_num_ro}/auxtriggers/0/slope', 2)
        self.hdawg.setInt(f'/{awg_name_ro}/triggers/out/1/source', 1)
        self.hdawg.setInt(f'/{awg_name_ro}/triggers/streams/0/enable', 1)
        self.hdawg.setInt(f'/{awg_name_ro}/triggers/streams/0/mask', 0x001)
